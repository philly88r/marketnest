  ...
  return (
    <HeaderContainer>
      ...
      <NavContainer>
        {isHomePage ? (
          <>
            ...
            <ScrollLink to="faq" smooth={true} duration={500} offset={-100}>
              <NavItem>Faq</NavItem>
            </ScrollLink>
      ...
      <MobileMenu $isOpen={mobileMenuOpen}>
        ...
        {isHomePage ? (
          <>
            <ScrollLink to="home" smooth={true} duration={500} offset={-100} onClick={toggleMobileMenu}>
            ...
            <ScrollLink to="features" smooth={true} duration={500} offset={-100} onClick={toggleMobileMenu}>
              <MobileNavItem>Features</MobileNavItem>
            </ScrollLink>
            <ScrollLink to="faq" smooth={true} duration={500} offset={-100} onClick={toggleMobileMenu}>
              <MobileNavItem>Faq</MobileNavItem>
            </ScrollLink>
